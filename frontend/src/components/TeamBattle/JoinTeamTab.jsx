export const JoinTeamTab = ({ joinCode, setJoinCode, teamLoading, onJoinTeam }) => {
  return (
    <div className="max-w-xl mx-auto premium-card p-12 lg:p-16" style={{ borderRadius: "2px" }}>
      ...
      <h2 className="text-4xl font-black text-[var(--color-text-main)] mb-10 tracking-tighter uppercase font-[family:var(--font-heading)]">Join Cluster</h2>

      <form onSubmit={onJoinTeam} className="space-y-10">
        <div>
          <label className="block text-[10px] font-bold text-[var(--color-text-muted)] uppercase tracking-[0.3em] mb-4 text-center">
          ...
          <input
            ...
            placeholder="000 000"
            className="w-full bg-white/[0.02] border border-white/5 px-6 py-6 text-[var(--color-text-main)] text-center font-mono text-4xl tracking-widest focus:outline-none focus:border-[var(--color-primary)]/40 transition-all"
            maxLength="6"
      ...
      <div className="mt-12 p-8 bg-white/[0.02] border border-white/5" style={{ borderRadius: "2px" }}>
        <h4 className="text-[11px] font-bold uppercase tracking-[0.4em] mb-4 text-[var(--color-text-main)]">Protocol Memo:</h4>
        <ul className="text-[10px] text-[var(--color-text-muted)] font-bold uppercase tracking-widest space-y-3">
